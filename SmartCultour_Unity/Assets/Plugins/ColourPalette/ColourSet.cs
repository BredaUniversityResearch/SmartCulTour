...
namespace ColourPalette
{
    ...
    public class ColourSet
    {
        ...
        [ListDrawerSettings(HideAddButton = true, HideRemoveButton = true, NumberOfItemsPerPage = 30, DraggableItems = false)]
