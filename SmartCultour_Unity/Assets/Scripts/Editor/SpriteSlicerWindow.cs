...
public class SpriteSlicerWindow : OdinEditorWindow
{
	...
	public void Slice()
	{
		...
		{
			m_result = "No sprite selected.";
			return;
		}
		if(m_slices == 0)
		{
			m_result = "No target slices selected.";
			return;
		}
		...
		if ((m_slices & SliceResult.Full) != 0)
		{
		...
		if ((m_slices & SliceResult.Bottom) != 0)
		{
			smd = new SpriteMetaData();
			smd.alignment = 9;
			smd.pivot = new Vector2(0.5f, 0.5f);
		...
		if ((m_slices & SliceResult.Left) != 0)
		{
			smd = new SpriteMetaData();
			smd.alignment = 9;
			smd.pivot = new Vector2(0.5f, 0.5f);
		...
		if ((m_slices & SliceResult.Right) != 0)
		{
			smd = new SpriteMetaData();
			smd.alignment = 9;
			smd.pivot = new Vector2(0.5f, 0.5f);
		...
		if ((m_slices & SliceResult.TopRight) != 0)
		{
			smd = new SpriteMetaData();
			smd.alignment = 9;
			smd.pivot = new Vector2(0.5f, 0.5f);
		...
		if ((m_slices & SliceResult.BottomRight) != 0)
		{
			smd = new SpriteMetaData();
			smd.alignment = 9;
			smd.pivot = new Vector2(0.5f, 0.5f);
		...
		if ((m_slices & SliceResult.BottomLeft) != 0)
		{
			smd = new SpriteMetaData();
			smd.alignment = 9;
			smd.pivot = new Vector2(0.5f, 0.5f);
		...
		if ((m_slices & SliceResult.TopLeft) != 0)
		{
			smd = new SpriteMetaData();
			smd.alignment = 9;
			smd.pivot = new Vector2(0.5f, 0.5f);
